...
const ABOUT_HERO_COPY = {
  ...
  role: "资深视觉设计师",
  introduction:
    "10+ 年视觉设计与品牌营销经验，具备消费电子、家居新零售与 4A/创意公司复合背景，曾管理 8 人视觉团队。擅长新品发布视觉、品牌级 Campaign、视觉系统与多触点物料统筹，具备拍摄美术、外部供应商及跨部门协同经验，能从创意方向、设计提案到落地执行完整推进 ▮",
  mobileIntroduction:
    "10+ 年视觉设计与品牌营销经验，具消费电子、家居新零售及 4A 复合背景，曾管理 8 人团队。擅长新品发布、品牌活动、视觉系统与多触点物料统筹，具备从创意提案到跨部门协同落地的全流程能力。",
} as const;
