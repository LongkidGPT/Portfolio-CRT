...
const ABOUT_HERO_COPY = {
  eyebrow: "BRAND CREATIVE · AI-NATIVE",
  name: "我是KID（龙昊翔）",
  role: "资深视觉设计师",
  introduction:
    "10+ 年视觉设计与品牌营销经验，具备消费电子、家居新零售与 4A/创意公司复合背景，曾管理 8 人视觉团队。擅长全球新品发布、品牌视觉系统、产品价值转译与跨触点内容落地，持续探索 AI 创意生产流程，能从创意方向、视觉探索、设计提案到协同执行完整推进 ▮",
  mobileIntroduction:
    "10+ 年品牌与视觉设计经验，具消费电子、家居新零售及 4A 复合背景，曾管理 8 人团队。擅长全球新品发布、品牌视觉系统、产品价值转译与 AI 创意流程，能够从创意方向到多触点落地完整推进。",
} as const;
