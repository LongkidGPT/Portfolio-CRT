...
const ABOUT_HERO_COPY = {
  ...
  role: "资深视觉设计师",
  introduction:
    "10+ 年品牌与营销视觉，消费电子（Anker）和 4A 出身，做过从 0→1 的品牌视觉体系。这几年主要做海外市场——北美 DTC 页面、国际展会主视觉，从策略到画面。AIGC 不只用来出图，我把它做成了带审核标准的工作流 ▮",
  mobileIntroduction:
    "10+ 年品牌与营销视觉，消费电子（Anker）和 4A 出身，做过从 0→1 的品牌视觉体系。这几年主要做海外市场——北美 DTC 页面、国际展会主视觉。AIGC 不只用来出图，我把它做成了带审核标准的工作流。",
} as const;
