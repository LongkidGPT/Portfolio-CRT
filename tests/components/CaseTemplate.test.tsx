...
test("about template links experience rows to the ruler and rebuilds the contact card", () => {
  ...
  expect(screen.getByText(
    "10+ 年视觉设计与品牌营销经验，具备消费电子、家居新零售与 4A/创意公司复合背景，曾管理 8 人视觉团队。擅长消费电子新品发布视觉与品牌视觉语言，从创意构思到成品执行。对我来说设计不止是一张图，更想用技术把想法做成能玩起来的东西▮",
  )).toBeInTheDocument();
  expect(screen.getByText(
    "10+ 年视觉设计与品牌营销经验，具消费电子、家居新零售与 4A 复合背景，曾管理 8 人团队。主张以技术赋能视觉，创造具互动性与落地价值的设计▮",
  )).toBeInTheDocument();
